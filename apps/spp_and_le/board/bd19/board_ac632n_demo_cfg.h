...
#define TCFG_IOKEY_KEY1_CONNECT_WAY		ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_KEY1_ONE_PORT			IO_PORTB_00        //IO按键端口
#define TCFG_IOKEY_KEY1_ONE_PORT_VALUE		0x1                //key1 port键值，不能设为0,key_value初始化为0,会误推keep事件

#define TCFG_IOKEY_KEY2_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_KEY2_ONE_PORT			IO_PORTB_01
#define TCFG_IOKEY_KEY2_ONE_PORT_VALUE		0x2              //key2 port键值

#define TCFG_IOKEY_KEY3_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_KEY3_ONE_PORT			IO_PORTB_02
#define TCFG_IOKEY_KEY3_ONE_PORT_VALUE		0x3              //key3 port键值

#define TCFG_IOKEY_KEY4_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_KEY4_ONE_PORT			IO_PORTB_03
#define TCFG_IOKEY_KEY4_ONE_PORT_VALUE		0x4              //key4 port键值
 ...
 */
#define TCFG_CHARGE_MA						CHARGE_mA_220
...
#define TCFG_LOWPOWER_POWER_SEL				PWR_DCDC15_FOR_CHARGE                    //电源模式设置，可选DCDC和LDO
