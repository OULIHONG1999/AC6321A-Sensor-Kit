 ...
 */
/*************************************************************************************************/
static int spple_state_machine(struct application *app, enum app_state state,
                               struct intent *it) {
  switch (state) {
  case APP_STA_CREATE:
    break;
...
static void spple_key_event_handler(struct sys_event *event) {
  ...
  if (event->arg == (void *)DEVICE_EVENT_FROM_KEY) {
    ...
    if (event_type == KEY_EVENT_CLICK && key_value == TCFG_ADKEY_VALUE0) {
      ...
      /*encode test*/
      /* extern int audio_mic_enc_open(int (*mic_output)(void *priv, void *buf,
       * int len), u32 code_type); */
      ...
      */
      ...
      /* extern int audio_demo_enc_open(int (*demo_output)(void *priv, void
       * *buf, int len), u32 code_type, u8 ai_type); */
 ...
 */
/*************************************************************************************************/
static int spple_event_handler(struct application *app,
 ...
 */
/*************************************************************************************************/
static u8 spple_state_idle_query(void) { return !is_app_spple_active; }
